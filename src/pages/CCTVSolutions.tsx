          ...
          <AnimatedSection>
            ...
            <div className="flex gap-4 justify-center mt-8">
              ...
              <a href="tel:+918667580862">
                <Button size="lg" className="bg-primary-foreground text-primary hover:bg-primary-foreground/95 hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 active:scale-95 transition-all duration-200 font-semibold shadow-lg">
                  Call Us Now
                </Button>
              </a>
            </div>
